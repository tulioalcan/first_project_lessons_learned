...
Projeto realizado através do curso de Desenvolvimento Web da Trybe. Nesse projeto, foi proposto o desenvolvimento de um site que continha uma série de informações sobre o que eu havia aprendido na Trybe ao longo dos três primeiros blocos, sendo eles:  Bloco 01. Unix &amp; Bash.  Bloco 02. Git &amp; GitHub e Internet. Bloco 03. Introdução à HTML e CSS. O site deveria conter elementos posicionados e estilizados e, além disso, deveria conter semântica apropriada para ser acessível e melhor ranqueado. 
